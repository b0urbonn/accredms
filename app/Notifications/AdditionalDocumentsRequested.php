...
class AdditionalDocumentsRequested extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => "Additional evidence was requested for {$this->documentRequest->subfolder->code} - {$this->documentRequest->subfolder->name}.",
            'area_id' => $this->areaId,
